...
export const Tugasvendor = [
  {
    id: 1,
    name: "Rangkuman Materi Dasar- dasar CSS",
    batas: "Batas pengumpulan : 21/10/23 - 23/10/23 ( 22.59 WIB)",
    task1: "Materi CSS 1",
    task2: "Materi CSS 2",
    status: "belum",
  },
  {
    id: 2,
    name: "Pengetahuan awal tentang CSS",
    batas: "Batas pengumpulan : 19/10/23 - 20/10/23 ( 22.59 WIB)",
    task1: "Pengertian CSS",
    task2: "Sifat dan Prinsip CSS",
    status: "selesai",
  },
];
...
export const NotifikasiVendor = [
  ...
  {
    title: "Selamat! Pencapaian bulan ini meningkat",
