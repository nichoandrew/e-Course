                  ...
                  <div>
                    <div>
                      ...
                      <div className="px-2.5 sm:px-5 md:px-8 lg:px-11 py-3 sm:py-4 md:py-6 lg:py-9 divide-y-2">
                        ...
                        <div className="flex gap-3 bg-[#F8F5F5] justify-center px-2 py-4 font-semibold rounded-xl shadow-md">
                          <Image className="text-[#055EA8]" src={surveiline} alt="surveitugas" width={40} height={40}/>
                          <p className="text-[#055EA8] text-sm lg:text-base pt-2">Belum ada tugas yang Anda Tambahkan</p>
                        </div>
                      </div>
                      <div className="px-2.5 sm:px-5 md:px-8 lg:px-11 py-3 sm:py-4 md:py-6 lg:py-9 divide-y-2">
